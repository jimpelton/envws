...
public class JobData implements Serializable {
    ...
    /// <summary>
    /// the private working set size (memory usage) of this job.
    /// </summary>
    ...
    /**
     * Gets a reference to the empty job prototype object.
     *
     * @return
     */
    ...
    private boolean _isEmptyJob = false;
    private static final JobData _emptyJob = new JobData(true);

    private JobData() { }

    private JobData(boolean isEmptyJob) {
        _isEmptyJob = isEmptyJob;
    }
    ...
    public static JobData deepCopy(JobData rhs) {
        ...
        copy._isEmptyJob = rhs._isEmptyJob;
    ...
    public boolean equals(Object o) {
        ...
        if (this._isEmptyJob && jobData._isEmptyJob) return true;
